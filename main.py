...
raise ValueError(str(args[0]) + ’ gecerli bir yil degil.’)
...
return await reply_error(update, str(e))
LISTE = [
(0,10,‘Asure Gunu’),(1,12,‘Mevlid Kandili’),(6,27,‘Mirac Kandili’),
(7,15,‘Berat Kandili’),(8,1,‘Ramazan Baslangici’),(8,27,‘Kadir Gecesi (~)’),
(9,1,‘Ramazan Bayrami 1. Gun’),(9,2,‘Ramazan Bayrami 2. Gun’),
(9,3,‘Ramazan Bayrami 3. Gun’),(11,9,‘Arefe Gunu’),
(11,10,‘Kurban Bayrami 1. Gun’),(11,11,‘Kurban Bayrami 2. Gun’),
(11,12,‘Kurban Bayrami 3. Gun’),(11,13,‘Kurban Bayrami 4. Gun’),
]
...
correct += 1
sign = ‘+’ if diff >= 0 else ‘’
lines.append(tag + ’ ’ + str(year) + ’ Hesap:’ + str(m) + ’ Gercek:’ + str(real) + ’ Fark:’ + sign + str(diff))
total += 1
...
await update.message.reply_text(‘Beklenmeyen hata olustu. /yardim yazin.’)
